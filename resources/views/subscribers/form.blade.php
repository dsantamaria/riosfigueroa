...
@section('content')
    ...
    <div class="col-md-8 col-md-offset-2">
        <div class="panel panel-primary" style="overflow: visible;">
            <div class="panel-heading">Nuevos Suscriptores</div>
            <div class="panel-body">
                {!! Form::open(['method'=>'post','route'=>'saveSubscriberForm',
                'class'=>'form-horizontal'])  !!}
                <div class="form-group">
                    <label class="col-md-3 control-label">Nombre de la Empresa</label>
                    <div class="col-md-8">
                        {!! Form::text('company_name', '',  array('id' => 'company_name', 'class' => 'form-control', 'required' => 'required')) !!}
                    </div>
                </div>
                <div class="form-group">
